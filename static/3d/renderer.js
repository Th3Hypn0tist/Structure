...
(() => {
  ...
  class Renderer {
    constructor({ box = null, line = null, point = null, text = null, primitive = null } = {}) {
      for (const [name, fn] of Object.entries({ box, line, point, text, primitive })) {
        if (fn !== null && typeof fn !== 'function') throw new Error(`Renderer ${name} callback must be a function or null`);
      }
      this.handlers = { box, line, point, text, primitive };
    }
